...
parser = argparse.ArgumentParser(description="ByteTrack Evaluation (boxmot)")
...
OUT_DIR = os.path.join(BASE_OUT, "bytetrack", VIDEO_NAME)
os.makedirs(OUT_DIR, exist_ok=True)

OUTPUT_VIDEO      = os.path.join(OUT_DIR, f"{VIDEO_NAME}_bytetrack.mp4")
...
motp_distance = summary.loc['SingleTarget-Bytetrack', 'motp']
